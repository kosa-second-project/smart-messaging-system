...
public enum ErrorCode {
    ...
    INTERNAL_SERVER_ERROR(500, "SYS-500",
            "서버 내부 오류가 발생했습니다.");INTERNAL_SERVER_ERROR(500,"SYS-500","서버 내부 오류가 발생했습니다."),EXTERNAL_API_ERROR(502,"API-502","외부 API 연동 중 오류가 발생했습니다.");
